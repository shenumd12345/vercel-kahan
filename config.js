...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "IK~QDlEnKhI#Eio8eT_UkaKSf8rVVlL7RbUVtftTek-Fc3D21UDVNSY",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "+1 (587) 997-4367",  // Owner's WhatsApp number
